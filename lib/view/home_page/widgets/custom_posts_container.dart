         ...
         children: [
          ListTile(
            leading: CircleAvatar(
              radius: 16,
              backgroundImage: NetworkImage("Http://images.pexels.com/photos/1831545/pexels-photo-1831545.jpeg?auto=compress&cs=tinysrgb&w=600"),
            ),
                    ...
                    children: List.generate(
                      ...
                      child: CircleAvatar(
                       backgroundColor: (index == currentPage -1)
                         ...
                         : Colors.grey.withOpacity(.3), /// or use 'null'.
